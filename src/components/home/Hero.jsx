...
const DEFAULT_PROFILE = "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=600";

const Hero = ({ settings }) => {
  const videoUrl = settings?.heroVideoUrl || DEFAULT_VIDEO;
  const imageUrl = settings?.heroImageUrl || DEFAULT_IMAGE;
  const profileUrl = settings?.profileImageUrl || DEFAULT_PROFILE;
  ...
  const photographerName = settings?.photographerName || "Toiyab";
  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl px-6 mx-auto text-center flex flex-col items-center pt-16">
        ...
        >
          {/* Prominent & Responsive Profile Container */}
